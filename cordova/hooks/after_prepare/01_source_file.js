// deployment of icons and splashs for iOS and Android, from the res folder into the correct folder
#!/usr/bin/env node
 
var shell = require( "shelljs" );

shell.exec( "cp -R ./www/res/screen/ios/* platforms/ios/PROJECT_NAME/Resources/splash" );
shell.exec( "cp -R ./www/res/icon/ios/* platforms/ios/PROJECT_NAME/Resources/icons" );
